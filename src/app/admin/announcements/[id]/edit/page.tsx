  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        actions={<div className="flex gap-2">{announcement.isDemo && <Badge variant="warning">DEMO</Badge>}<PublicationStatusBadge status={announcement.publicationStatus} /></div>}
      />
